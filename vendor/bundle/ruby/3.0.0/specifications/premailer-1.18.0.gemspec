# -*- encoding: utf-8 -*-
# stub: premailer 1.18.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<css_parser>.freeze, [">= 1.12.0"])
    ...
    s.add_development_dependency(%q<nokogiri>.freeze, ["~> 1.13"])
    ...
    s.add_dependency(%q<css_parser>.freeze, [">= 1.12.0"])
